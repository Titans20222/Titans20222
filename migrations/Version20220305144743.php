 ...
 */
final class Version20220305144743 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE evenement ADD prix DOUBLE PRECISION NOT NULL, DROP nom_evenement');
    }
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE evenement ADD nom_evenement VARCHAR(255) DEFAULT NULL COLLATE `utf8mb4_unicode_ci`, DROP prix, CHANGE lat lat VARCHAR(255) NOT NULL COLLATE `utf8mb4_unicode_ci`');
