 ...
 */
final class Version20220305181331 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE evenement ADD nom_lieu VARCHAR(255) NOT NULL, DROP `long`, CHANGE lat nom_evenement VARCHAR(255) NOT NULL');
    }
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE evenement ADD lat VARCHAR(255) NOT NULL COLLATE `utf8mb4_unicode_ci`, ADD `long` INT NOT NULL, DROP nom_evenement, DROP nom_lieu');
