 ...
 */
final class Version20220305173449 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE evenement ADD nbrplacedispo INT NOT NULL');
    }
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE evenement DROP nbrplacedispo, CHANGE lat lat VARCHAR(255) NOT NULL COLLATE `utf8mb4_unicode_ci`');
